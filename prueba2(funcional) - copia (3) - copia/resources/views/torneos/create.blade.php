<x-app-layout>
    <div class="container mx-auto px-4 py-8">
        <h1 class="text-white text-4xl font-bold mb-8 text-center">Crear Torneo</h1>
        <form action="{{ route('torneos.store') }}" method="POST">
            ...
            <div class="form-group mb-4">
                ...
                <input type="text" name="organizador" class="form-control text-black">
            </div>
            <div class="form-group mb-4">
                <label for="nombre_torneo" class="text-white">Nombre del Torneo</label>
                <input type="text" name="nombre_torneo" class="form-control text-black">
            </div>
            <div class="form-group mb-4">
            ...
            <div class="form-group mb-4">
                ...
                <input type="number" name="cupos_totales" class="form-control text-black">
            </div>
            <div class="form-group mb-4">
                <label for="fecha_inicio" class="text-white">Fecha de Inicio</label>
                <input type="date" name="fecha_inicio" class="form-control text-black">
            </div>
            <div class="form-group mb-4">
                <label for="costo_inscripcion" class="text-white">Costo de Inscripción</label>
                <input type="text" name="costo_inscripcion" class="form-control text-black">
            </div>
            <div class="form-group mb-4">
                <label for="descripcion" class="text-white">Descripción</label>
                <textarea name="descripcion" class="form-control text-black"></textarea>
            </div>
            <button type="submit" class="bg-blue-500 hover:bg-blue-600 text-white font-semibold py-2 px-4 rounded-lg">Crear</button>
        </form>
    </div>
</x-app-layout>
